	...
	<div class="container">
		...
		<div class="row mt-30">
			<div class="col-md-12">
				...
				<div align="center">
				Inserisci la data di inizio:<br><input type="date" min="1920-01-01" max="2030-12-31" name="dateStart"><br><br>
				Inserisci la data di fine:<br><input type="date" min="1920-01-01" max="2030-12-31" name="dateEnd"><br><br>
